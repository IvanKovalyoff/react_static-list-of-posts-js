...
aut aut aut maxime quia temporibus ut omnis`}],Lc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],tm=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({comment:e})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:j.jsx(tm,{user:{name:e.email,email:e.email}})})]}),j.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Mc=({comments:e})=>j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Tc,{comment:t},t.id))}),Rc=({post:e})=>j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:"doloremque illum aliquid sunt"}),j.jsxs("p",{children:[" Posted by  ",j.jsx(tm,{user:e.user})]})]}),j.jsx("p",{className:"PostInfo__body",children:e.body}),j.jsx("hr",{}),e.comments.length===0?j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):j.jsx(Mc,{comments:e.comments})]}),Dc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Rc,{post:t},t.id))}),im=Nc.map(e=>({...e,user:Lc.find(t=>t.id===e.userId),comments:Pc.filter(t=>t.postId===e.id)}));im.sort((e,t)=>e.id-t.id);const jc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Dc,{posts:im})]});em(document.getElementById("root")).render(j.jsx(jc,{}));
